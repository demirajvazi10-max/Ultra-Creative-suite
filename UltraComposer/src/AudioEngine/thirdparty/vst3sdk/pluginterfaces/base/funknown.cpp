...
// UltraComposer: this file calls plain strcpy/sscanf/sprintf/etc., and
// MSVC's /sdl project option turns the resulting C4996 deprecation notice
// into a hard build error. Defined right here (before any CRT header is
// included) so it's guaranteed to apply no matter what the project file
// says, since /sdl escalates these specific warnings project-wide.
